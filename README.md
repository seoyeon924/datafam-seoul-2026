...
## 2026-08-19 리뷰 반영 패스 (몰입 재설계)

- 제목: Claude Code와 Tableau MCP로 만드는 AI 분석 워크플로우
- 오프닝 훅 「오늘의 변화」 신설 · 지금 vs 오늘 두 줄 비교
- 2장 5장으로 압축 (기존 방식 → 한계 → Agent · Rule · Skill → 실행 → 남는 것) · CLAUDE.md · Rule · 체크포인트 · 시각화 · 에이전트 표 · 산출물 3장은 부록 A1~A6
- 연결 방식 3.3으로 전진 배치 · TC26 한 장 합본(방향 + 시연 3)
